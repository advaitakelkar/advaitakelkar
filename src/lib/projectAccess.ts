...
export const PUBLIC_PROJECT_SLUGS = ['alt-verse','architect-x-architects','carlo','concrt','dhal-ni-pol','shelf','future-of-dance','human-pods','indian-royals','sups-cards','sups-in-the-hinterland'] as const;
